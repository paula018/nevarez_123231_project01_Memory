...
def main():
    ...
    for i in range(5):
        ...
        if i >= 0:
            square = Rectangle(Point(x2, y1), Point(x1, y2))           
            ...
            time.sleep(.5)
            if i >= 1:
                square = Rectangle(Point(x3, y3), Point(x4, y4))           
                square.setFill("black")
                square.draw(win)
                time.sleep(1)
                square.undraw()
                time.sleep(.5)
                if i >= 2: 
                    square = Rectangle(Point(x6, y6), Point(x5, y5))           
                    square.setFill("black")
                    square.draw(win)
                    time.sleep(1)
                    square.undraw()
                    time.sleep(.5)
                    if i >= 3:
                        square = Rectangle(Point(x8, y7), Point(x7, y8))           
                        square.setFill("black")
                        square.draw(win)
                        time.sleep(1)
                        square.undraw()
                        time.sleep(.5)
                        if i == 4:
                            square = Rectangle(Point(x9, y9), Point(x10, y10))           
                            square.setFill("black")
                            square.draw(win)
                            time.sleep(1)
                            square.undraw()
